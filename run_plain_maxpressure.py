...
def collect_data(engine: cityflow.Engine, graph: RoadnetGraph, n_steps: int, hidden_intersections: Set[str] = None,
                 agents: List[Agent] = None, reset_pre=True, reset_post=True, print_info=True) -> List[Dict[str, Any]]:
    if reset_pre:
        engine.reset()
